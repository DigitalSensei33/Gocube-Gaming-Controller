## IMPORTANT:
Currently, setup.bat and run.bat are experimental, and not fully tested yet.
...
This used Ignisco's smartcube gaming controller repo (https://github.com/ignisco/Smart-Cube-Gaming-Controller) as a basic starting point/template. The only real remaining stuff from their build is a good chunk of directinput.py (renamed in my repo to sendinput.py.)
